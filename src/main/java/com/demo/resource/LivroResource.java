...
public class LivroResource {
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<Livro> update(@PathVariable Integer id, @RequestBody Livro obj) throws ObjectNotFoundException{
	...
	public ResponseEntity<Livro> create(@RequestParam(value = "categoria", defaultValue = "0") Integer id_cat,
										@RequestBody Livro obj) throws ObjectNotFoundException { 
